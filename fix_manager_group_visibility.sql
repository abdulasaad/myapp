-- Fix managers not seeing agents in their groups
-- Create a separate function for group-based agent visibility
...
-- Test manager function (replace with actual manager ID)
SELECT 'Manager Function Test:' as test_name;
SELECT id, full_name, connection_status, group_name 
FROM get_agents_in_manager_groups('38e6aae3-efab-4668-b1f1-adbc1b513800')  -- Mostafa's ID
ORDER BY full_name;

-- Test admin function
SELECT 'Admin Function Test:' as test_name;
SELECT id, full_name, connection_status 
