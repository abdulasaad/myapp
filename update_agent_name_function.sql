-- Alternative approach: Create a database function to update agent names
-- This bypasses RLS entirely and handles permissions internally
...
/*
SELECT update_agent_name_secure(
    'AGENT_USER_ID_HERE'::UUID,
    'New Agent Name'
);
*/